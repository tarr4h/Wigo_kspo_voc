...
public String init(@RequestParam Map<String, Object> param, ModelMap model) throws EgovBizException {
    ...
    return Utilities.getProperty("tiles.voc") + "sys/authChgLogList";
}
...
public @ResponseBody Object save(@RequestBody GrpMenuHstVo vo) throws EgovBizException {
    return service.save(vo);
}

@PostMapping(value = { "saveList" })
public @ResponseBody Object saveList(@RequestBody List<GrpMenuHstVo> list) throws EgovBizException {
    return service.saveList(list);
}
@PostMapping(value = { "deleteList" })
public @ResponseBody Object deleteList(@RequestBody List<GrpMenuHstVo> list) throws EgovBizException {
