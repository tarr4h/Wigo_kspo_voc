...
<head>
    ...
    <!-- ======================= css ===================== -->
<!--     <link rel="stylesheet" href="/static/voc/css/style.css"> -->
    ...
    <header class="header">
        <div class="container">
            <div class="header_menu">
                <a href="#" class="full_menu" id="full-toggle"><img src="/static/voc/images/menu.png" alt="fullmenu"></a>
                <h1><a href="/"><img src="/static/voc/images/logo.png" alt=""></a></h1>
            ...
            <div class="header_user">
                <img src="/static/voc/images/user1.png" alt="">
...
<!--             콘텐츠 -->
        ...
        <div class="wedget">
            <a href="#">
                <img src="/static/voc/images/widget1.png" alt="">
                <span>위젯1</span>
            </a>
            <a href="#">
                <img src="/static/voc/images/widget2.png" alt="">
                <span>위젯2</span>
            </a>
            <a href="#">
                <img src="/static/voc/images/widget3.png" alt="">
                <span>위젯3</span>
            </a>
        </div>
